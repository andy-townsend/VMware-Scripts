...
$MailFrom = "snapshot-reminder@vcenter.com"
$VC1 = "vcenter"
$default_mail_tgt = "andy_townsend@symantec.com"
...
foreach ($snap in ( Get-VM | Get-Snapshot | Where {$_.Created -lt ((Get-Date).AddHours(-$Age))}))
{
